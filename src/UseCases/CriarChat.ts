...
class CriarChat
{
    ...
    constructor(chatRepository: IChatRepository, apelidoParticipante1: string, apelidoParticipante2: string)
    {
    ...
    execute()
    {
        ...
        const RESPOSTA = this.chatRepository.criarChat(APELIDO_PARITIPANTE_1, APELIDO_PARITIPANTE_2);
